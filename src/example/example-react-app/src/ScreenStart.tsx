...
export default function ScreenStart() {
    ...
    function submit(e: FormEvent<HTMLFormElement>) {
        ...
        push(EventTypes.GameNew, { game_id });
        push(EventTypes.GameConfigured, { game_id, config });
        push(EventTypes.PlayerReady, { game_id, player_id });
        push(EventTypes.GameStarted, { game_id });
    }
